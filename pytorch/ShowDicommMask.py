...
class ImageViewer(QMainWindow):
    ...
    def initUI(self):
        ...
        # Slider to control the transparency and slice
    ...
    def update_images(self, slice_number):
        ...
        # Load images and convert to QImage
...
if __name__ == '__main__':
    ...
    num = 0
    dicom_dir = f'C:/Users/kosty/OneDrive/MyDocuments/ProjectsTemp/Diploma/PatientData/I_00{num:02d}/DICOMTIFF'
    mask_dir = f'C:/Users/kosty/OneDrive/MyDocuments/ProjectsTemp/Diploma/PatientData/I_00{num:02d}/Masks'
    ex = ImageViewer(dicom_dir, mask_dir, 141, 184, num)
    ex.show()
    sys.exit(app.exec_())
